...
-- Dumping structure for table mytugasakhir.assets
...
-- Dumping data for table mytugasakhir.assets: ~3 rows (approximately)
/*!40000 ALTER TABLE `assets` DISABLE KEYS */;
REPLACE INTO `assets` (`id`, `category_id`, `name`, `location`, `created_at`, `updated_at`) VALUES
	(1, 1, 'Kota', 'assets/assets/1535614399city-background-design_1300-365.jpg', '2018-08-30 07:33:19', '2018-08-30 07:33:19'),
	(2, 2, 'Kucing', 'assets/assets/1535614974cat.png', '2018-08-30 07:42:54', '2018-08-30 07:42:54'),
	(3, 2, 'Kucing', 'assets/assets/1535614997cat_PNG50538.png', '2018-08-30 07:43:17', '2018-08-30 07:43:17');
/*!40000 ALTER TABLE `assets` ENABLE KEYS */;

-- Dumping structure for table mytugasakhir.blockedwords
...
-- Dumping data for table mytugasakhir.blockedwords: ~0 rows (approximately)
/*!40000 ALTER TABLE `blockedwords` DISABLE KEYS */;
/*!40000 ALTER TABLE `blockedwords` ENABLE KEYS */;

-- Dumping structure for table mytugasakhir.books
...
-- Dumping data for table mytugasakhir.books: ~0 rows (approximately)
/*!40000 ALTER TABLE `books` DISABLE KEYS */;
/*!40000 ALTER TABLE `books` ENABLE KEYS */;

-- Dumping structure for table mytugasakhir.canvas
...
-- Dumping data for table mytugasakhir.canvas: ~0 rows (approximately)
/*!40000 ALTER TABLE `canvas` DISABLE KEYS */;
/*!40000 ALTER TABLE `canvas` ENABLE KEYS */;

-- Dumping structure for table mytugasakhir.categories
...
-- Dumping data for table mytugasakhir.categories: ~2 rows (approximately)
...
-- Dumping structure for table mytugasakhir.migrations
...
-- Dumping data for table mytugasakhir.migrations: ~10 rows (approximately)
...
-- Dumping structure for table mytugasakhir.password_resets
...
-- Dumping data for table mytugasakhir.password_resets: ~0 rows (approximately)
/*!40000 ALTER TABLE `password_resets` DISABLE KEYS */;
/*!40000 ALTER TABLE `password_resets` ENABLE KEYS */;

-- Dumping structure for table mytugasakhir.profiles
...
-- Dumping data for table mytugasakhir.profiles: ~2 rows (approximately)
/*!40000 ALTER TABLE `profiles` DISABLE KEYS */;
REPLACE INTO `profiles` (`id`, `user_id`, `avatar`, `username`, `address`, `created_at`, `updated_at`) VALUES
	(1, 1, 'assets/avatars/default.png', 'fadilnatakusumah', 'Jl. Kaliurang', '2018-08-30 05:01:51', '2018-08-30 05:01:51'),
	(2, 2, 'assets/avatars/default.png', 'fadilnatakusumah', 'Jl. Kaliurang 14.5', '2018-08-30 07:19:14', '2018-08-30 07:19:14');
/*!40000 ALTER TABLE `profiles` ENABLE KEYS */;

-- Dumping structure for table mytugasakhir.stopwords
...
-- Dumping data for table mytugasakhir.stopwords: ~758 rows (approximately)
/*!40000 ALTER TABLE `stopwords` DISABLE KEYS */;
REPLACE INTO `stopwords` (`id`, `created_at`, `updated_at`, `words`) VALUES
	(1, NULL, NULL, 'ada'),
	(2, NULL, NULL, 'adalah'),
	(3, NULL, NULL, 'adanya'),
	(4, NULL, NULL, 'adapun'),
...
-- Dumping structure for table mytugasakhir.suggestions
...
-- Dumping data for table mytugasakhir.suggestions: ~0 rows (approximately)
/*!40000 ALTER TABLE `suggestions` DISABLE KEYS */;
/*!40000 ALTER TABLE `suggestions` ENABLE KEYS */;

-- Dumping structure for table mytugasakhir.users
...
-- Dumping data for table mytugasakhir.users: ~2 rows (approximately)
/*!40000 ALTER TABLE `users` DISABLE KEYS */;
REPLACE INTO `users` (`id`, `name`, `email`, `password`, `admin`, `remember_token`, `created_at`, `updated_at`) VALUES
	(1, 'Admin', 'admin@gmail.com', '$2y$10$hhY2cuv1TLlb98pLEe3UGOMS7Xwk44ajJuBnsLVKB4kI7333XifM.', 1, 'M9OtqOCM1zZ40ArfWO7dtWnagMXGuUNJ5xUqRCR6IhRh9YyaRaXeEfXup3ZW', '2018-08-30 05:01:51', '2018-08-30 05:01:51'),
	(2, 'Muhammad Fadil Natakusumah', 'fadil_natakusumah@ymail.com', '$2y$10$s17/kyd5veSce.CBGT4AqOdi2Tr/Zyo2WmsOmo9.v9azmODqvu5I6', 0, '8ALDyoI1aBvkz13kbMmuHOZypd9fhJjwy5GApddEAa8eT6D6ODtyd9W4x1mL', '2018-08-30 06:50:00', '2018-08-30 06:50:00');
